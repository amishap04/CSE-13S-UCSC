...
assert(test1);
printf("Congrats! The first test case is now passing. You should remove the
assert statements that you added to "
"password_checker.c because these correspond to the first test case and
will not necessarily work for the "
